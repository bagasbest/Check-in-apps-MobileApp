...
public class Hotel_Data {
    ...
    private static String[] detailhotel = {
            ...
            "Terletak di wilayah Jakarta Selatan, wilayah padat penduduk, Sarapan pagi, Kamar mandi di dalam ",
            ...
            "Terletak di Lampung Selatan, Fasilitas Kipas Angin, Kamar mandi, Lemari baju, include sarapan pagi",
    ...
    private static String[] hargahotel = {
            "Rp. 350.000.00",
            "Rp. 300.000.00",
            "Rp. 200.000,00",
            "Rp. 300.000.00",
